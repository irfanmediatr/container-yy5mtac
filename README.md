...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-yy5mtac.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-yy5mtac.containers.anotherwebservice.com/
...
```
git clone git@github.com:irfanmediatr/container-yy5mtac.git
cd container-yy5mtac
```
...
```
docker attach container-yy5mtac
```
